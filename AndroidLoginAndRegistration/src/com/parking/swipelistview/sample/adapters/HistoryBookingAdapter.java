...
public class HistoryBookingAdapter extends BaseAdapter {
    ...
    public HistoryBookingAdapter(Context context,Activity activity, List<HistoryBookingVO> data) {
        this.ctx = context;
        this.data = data;
        this.act = activity;
    }
    
    public HistoryBookingAdapter(Context context,Activity activity, List<HistoryBookingVO> data,LoginData loginData) {
        this.ctx = context;
        this.data = data;
        this.act = activity;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = li.inflate(R.layout.history_booking_row, parent, false);
            holder = new ViewHolder();         
            holder.titleMall = (TextView) convertView.findViewById(R.id.titleMall);
            holder.valTanggalBooking = (TextView) convertView.findViewById(R.id.valTanggalBooking);
            holder.valBookingId = (TextView) convertView.findViewById(R.id.valBookingId);
            holder.valBookingCode = (TextView) convertView.findViewById(R.id.valBookingCode);
            holder.valStatusBooking = (TextView) convertView.findViewById(R.id.valStatusBooking);
...
//            holder.bAction3 = (ButtonRectangle) convertView.findViewById(R.id.example_row_b_action_3);
		...
		case Constants.STATUS_ALREADY_PAY:
			...
			holder.valStatusBooking.setTextColor(ctx.getResources().getColor(R.color.grey));
			break;
		case Constants.STATUS_ALREADY_CHECK_IN:
			status = Constants.STATUS_VAL_ALREADY_CHECK_IN;
			holder.valStatusBooking.setTextColor(ctx.getResources().getColor(R.color.pink));
			break;
		...
		case Constants.STATUS_ALREADY_CHECK_OUT:
			...
			holder.valStatusBooking.setTextColor(ctx.getResources().getColor(R.color.green));
			break;
		default:
